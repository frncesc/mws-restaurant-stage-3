...
restaurants.forEach(r => {
  ...
  const hours = JSON.stringify(r.operating_hours);

  console.log(`{"createdAt":${created},"updatedAt":${updated},"id":${r.id},"name":"${name}","photograph":"${r.photograph || ''}","neighborhood":"${r.neighborhood}","address":"${r.address}","latlng":${latlng},"cuisine_type":"${r.cuisine_type}","operating_hours":${hours},"is_favorite":${r.is_favorite},"_id":${r.id}}`);
});
